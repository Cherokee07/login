...
if((URLactual=="http://localhost/loginSeg/")||(URLactual=="http://localhost/loginSeg/index.php")){
	alert("Sitio Correcto");
}
else{
	
	alert("http://localhost/loginSeg/index.php"+"\n"+URLactual);
}
...
<body background="golf.jpg" style="background-attachment: fixed" >
